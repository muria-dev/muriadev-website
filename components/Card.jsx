...
export default function Card({ icon, title, deskripsi }) {
  return (
    <>
      <div className="px-4 text-white bg-[#3b3844] rounded-xl w-[418px] h-[520px] flex flex-col items-center justify-center duration-150 hover:shadow-md hover:shadow-blue-800">
